...
This frontend is designed to work alongside the **YoutuDown** backend — a Node.js/Express API that handles the actual video downloading.

> 🔗 **[angelr449/YoutuDown](https://github.com/angelr449/YoutuDown)**

The backend exposes the following capabilities:

- Individual YouTube video downloads (server-side & client-side stream)
- Full playlist downloads
- Video info extraction (resolution, duration, available formats)
...
Make sure the backend is running before starting this frontend. You can find setup instructions in its own repository.
